...
import 'package:modee_emrc_app/services/mineralextractionlicenserenewal-service/mineralextractionlicenserenewal-service.dart';
        ...
        '/${Screen.homeView.toShortString()}':(context){
          return Scaffold(
              ...
              body:  const Padding(
                ...
                child: MineralExtractionLicenseRenewalEMRCService()
              )
          );
        }
      },
